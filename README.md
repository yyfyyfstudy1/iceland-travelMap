...
| 文件 | 说明 |
|---|---|
| `index.html` | **MapLibre 版(推荐,GitHub Pages 主页)**:真实底图(**街道 / 卫星 / 地形** 可切换)+ 44 条线路按运营商着色。原生手势(滚轮/双指捏合/拖动)、悬停高亮、点击线路锁定、点圆点或右侧「途径点」多选筛线路、途径点自动避让标签、深/浅色。**需联网**(加载 MapLibre + 底图瓦片)。 |
